...
class XiaohongshuParser(ContentParser):
    """Parse Xiaohongshu video/note URLs."""
    ...
    async def parse(self, url: str, work_dir: Path) -> ParsedContent:
        return await extract_with_yt_dlp(url, work_dir, "xiaohongshu")
